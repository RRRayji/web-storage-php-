...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 22 2024 г., 10:34
...
INSERT INTO `приход` (`№_накладной`, `дата`, `тип_накладной`, `№_склада`, `название_склада`, `поставщик`, `наименование_поставщика`) VALUES
(1, '2024-03-15', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(2, '2024-03-16', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(3, '2024-03-17', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(4, '2024-03-18', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(5, '2024-03-19', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(6, '2024-03-20', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(7, '2024-03-21', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(8, '2024-03-22', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(9, '2024-03-23', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(10, '2024-03-24', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(11, '2024-03-25', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(12, '2024-03-26', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(13, '2024-03-27', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(14, '2024-03-28', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(15, '2024-03-29', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(16, '2024-03-30', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(17, '2024-03-31', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(18, '2024-04-01', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(19, '2024-04-02', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(20, '2024-04-03', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(21, '2024-04-04', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(22, '2024-04-05', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(23, '2024-04-06', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(24, '2024-04-07', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(25, '2024-04-08', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(26, '2024-04-09', 'Поступление от поставщика', 1, 'Склад №1', 1, 'ООО \"Агропром\"'),
(27, '2024-04-10', 'Поступление от поставщика', 2, 'Склад №2', 2, 'ЗАО \"Хлебозавод №1\"'),
(28, '2024-04-11', 'Возврат от покупателя', 1, 'Склад №1', 3, 'ИП \"Мясной мир\"'),
(29, '2024-04-12', 'Перемещение между складами', 2, 'Склад №2', 1, 'ООО \"Агропром\"'),
(30, '2024-04-13', 'Перемещение между складами', 3, 'Склад №3', 2, 'ЗАО \"Хлебозавод №1\"'),
(31, '2024-04-14', 'Поступление от поставщика', 2, 'Склад №2', 4, 'ООО \"Молочные продукты\"');
...
(1, 1, 'Ромашка', 50, 1700),
(1, 2, 'Русский караван', 50, 2000),
(1, 3, 'Зелёная поляна', 50, 2200),
(2, 5, 'Рогачев', 50, 1800),
(2, 4, 'Дарница', 15, 1350),
(3, 7, 'Своя ферма', 30, 3600),
(3, 8, 'Российский', 30, 13500),
(4, 9, 'Докторская', 15, 7200),
(4, 10, 'Гренни Смит', 10, 1800),
(5, 11, 'Бананы', 50, 2800),
(5, 12, 'Помидоры', 50, 6000),
(5, 13, 'Огурцы', 50, 5000);
